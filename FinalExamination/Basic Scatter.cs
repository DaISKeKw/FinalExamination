...
{
    public partial class Basic_Scattercs : Form
    {
        XYChartData.Chart chartData;
        BasicScatter chart;
        CartesianChart cartesianChart;
        int tmp = 0;
        public Basic_Scattercs()
        {
            InitializeComponent();
        ...
        private void Basic_Scattercs_Load(object sender, EventArgs e)
        {
        ...
        {
            chart = new BasicScatter(name, color);
        ...
        private void addLine_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("Виберіть колір серію на графіку");
        ...
        private void addPoint_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Оберіть серію", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
